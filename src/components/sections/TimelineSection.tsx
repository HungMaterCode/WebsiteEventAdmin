      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-display font-black uppercase tracking-wider mb-4">
            <span className="text-silver">Lộ Trình </span>
          ...
          {timeline.map((item, index) => (
            ...
            >
              ...
              <div className="w-full pl-12 sm:pl-16 md:pl-0 md:w-5/12">
                <div className="bg-royal/10 border border-royal/30 p-5 md:p-6 rounded-2xl backdrop-blur-sm hover:border-cyan/50 hover:bg-royal/20 transition-all duration-300 group">

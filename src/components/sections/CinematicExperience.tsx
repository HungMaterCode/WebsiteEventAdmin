  ...
  return (
    <section className="py-24 relative bg-midnight overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} onClick={onOpenVideo} className="relative aspect-video rounded-[2.5rem] overflow-hidden border border-royal/50 shadow-[0_0_50px_rgba(79,31,118,0.3)] group cursor-pointer">
          <img src="https://picsum.photos/seed/concert-wide/1920/1080" alt="Cinematic Teaser" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" referrerPolicy="no-referrer" />

  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-admin-panel/50 p-8 rounded-[2.5rem] border border-admin-border backdrop-blur-xl relative overflow-hidden">
        ...
        <div>
          <h2 className="text-3xl font-display font-black uppercase text-admin-text tracking-widest italic text-glow-magenta flex items-center gap-4">
            <MapPin className="text-magenta w-8 h-8" />
            Địa Điểm Tổ Chức
          </h2>
          <p className="text-admin-text-muted text-sm mt-2 font-medium tracking-wide">Quản lý nội dung địa điểm và bản đồ Google Maps</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
        ...
        <div className="space-y-8">
          <div className="glass-card p-8 rounded-[2.5rem] bg-admin-panel border border-admin-border shadow-2xl space-y-8 relative overflow-hidden">
            <div className="flex items-center gap-3 pb-6 border-b border-admin-border">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-admin-text italic">Nội dung văn bản</h3>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-admin-bg border border-admin-border rounded-2xl px-6 py-4 text-admin-text focus:outline-none focus:border-magenta transition-all font-bold tracking-wide"
                />
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-black text-admin-text-muted uppercase tracking-widest block pl-1">Tên địa điểm (Tiêu đề phụ)</label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-admin-bg border border-admin-border rounded-2xl px-6 py-4 text-admin-text focus:outline-none focus:border-magenta transition-all text-sm leading-relaxed"
                />
              </div>
        ...
        <div className="space-y-8">
          <div className="glass-card p-8 rounded-[2.5rem] bg-admin-panel border border-admin-border shadow-2xl space-y-8 relative overflow-hidden">
            <div className="flex items-center gap-3 pb-6 border-b border-admin-border">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-admin-text italic">Tích hợp Google Maps</h3>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-admin-bg border border-cyan/30 rounded-2xl px-6 py-4 text-xs text-cyan focus:outline-none focus:border-cyan transition-all font-mono"
                />
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-black text-admin-text-muted uppercase tracking-widest block pl-1">Xem trước bản đồ</label>
                <div className="rounded-3xl overflow-hidden border border-admin-border aspect-video relative bg-admin-bg">
                  {settings?.mapGoogleUrl ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-admin-text-muted">
